...
// Sets the robot to drive a specific distance (in inches). (this is blocking
// and will only exit once at the spefified distance)
void driveForDistance(double inches) {
